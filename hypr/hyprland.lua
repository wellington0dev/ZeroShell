...
local menu        = "qs ipc call launcher toggle" -- quickshell's own app launcher, replaces rofi
local captureMenu = "qs ipc call capture toggle"  -- menu de captura/gravação de tela
local helenaChat  = "qs ipc call helena toggle"   -- chat da Helena
local settingsWin = "qs ipc call settings toggle" -- janela de Configurações
...
hl.bind(mainMod .. " + H", hl.dsp.exec_cmd(helenaChat))
hl.bind(mainMod .. " + C", hl.dsp.exec_cmd(settingsWin))
...
hl.bind(mainMod .. " + SHIFT + S", hl.dsp.exec_cmd(captureMenu)) -- menu de captura/gravação de tela
