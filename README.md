...
- **Wallpaper** desenhado pelo `awww` (daemon externo, sucessor do
  `swww`) - matugen continua responsável só pela extração de cor a partir
  da mesma imagem.
...
- `awww` - daemon que desenha o wallpaper de verdade (sucessor do `swww`)
